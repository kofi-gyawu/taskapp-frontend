...
export class LoginComponent implements OnInit {
  ...
  redirectToCognito(){
    ...
    window.location.href = "https://sam-app-sam-app.auth.eu-central-1.amazoncognito.com/login?client_id=6f6vrq6b2o1gt90fj9tisses1r&redirect_uri=https://main.d2999je8ebi5mc.amplifyapp.com/&response_type=token"
  }
